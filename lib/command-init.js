...
function printMessage(){
    console.log("If you are building a new mobile or web app, \
or you're adding cloud capabilities to your existing app, \
use the new AWS Amplify CLI instead");
    console.log(); 
    console.log('To install the AWS Amplify CLI')
    console.log('    $ npm install -g @aws-amplify/cli')
    console.log('For more information, visit')
    console.log(chalk.green('    https://aws-amplify.github.io/'))
}

function runInit(initInfo){
