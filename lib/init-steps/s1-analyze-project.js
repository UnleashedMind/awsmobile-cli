...
function guessFramework(initInfo){
    ...
    if(packageJson && packageJson.dependencies){
        ...
        }else if(isObjectiveCProject(initInfo)){
            frameWorkName = 'objective-c'
        }else if(isSwiftProject(initInfo)){
            frameWorkName = 'swift'
        }
    }
...
function isObjectiveCProject(initInfo){
    return false
}

function isSwiftProject(initInfo){
    return false
}
